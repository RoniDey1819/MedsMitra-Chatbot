...
document.addEventListener('DOMContentLoaded', function () {
    ...
    toast.innerHTML = '<i class="fa-solid fa-circle-check"></i><span id="rxToastMsg">Added to cart</span>';
    ...
    document.querySelectorAll('form[data-demo-form]').forEach(function (form) {
        form.addEventListener('submit', function (e) {
            e.preventDefault();
            showToast(form.getAttribute('data-demo-form') || 'Submitted — thank you!');
            form.reset();
        });
    });
    ...
    document.querySelectorAll('.main-nav .nav-link[href]').forEach(function (link) {
